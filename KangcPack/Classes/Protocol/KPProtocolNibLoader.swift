...
public protocol KPProtocolNibLoader: class {
    static var nibName: String { get }
}

extension KPProtocolNibLoader {
    public static var nibName: String {
        return NSStringFromClass(self).components(separatedBy: ".").last!
    }
}

extension KPProtocolNibLoader where Self: UIView {
...
extension KPProtocolNibLoader where Self: UIViewController {
